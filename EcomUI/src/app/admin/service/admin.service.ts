...
export class AdminService {
  ...
  updateProduct(productId: any, productDto: any): Observable<any> {
    return this.http.put(BASIC_URL + `api/admin/products/${productId}`, productDto, {
      headers: this.createAuthorizationHeader(),
    });
  }
  ...
  getAllProductsByName(name: any): Observable<any> {
    return this.http.get(BASIC_URL + `api/admin/products/search?name=${encodeURIComponent(name)}`, {
      headers: this.createAuthorizationHeader(),
    });
  }
  ...
  postFAQ(productId: number, FaqDto: any): Observable<any> {
    ...
    return this.http.post(BASIC_URL + `api/admin/faq`, faqWithProduct, {
      headers: this.createAuthorizationHeader(),
    });
  }
